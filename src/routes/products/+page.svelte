		...
		<div>
					...
					>
						<g>
							<rect
								...
								rx="2.3"
								ry="2.3"
								transform="translate(-4.68 12.71) rotate(-45)"
								fill="#1ecd86"
							/>
							<rect
								x="-.53"
								...
								rx="2.3"
								ry="2.3"
								transform="translate(10.28 28.26) rotate(-135)"
								fill="#1ecd86"
							/>
							<rect
								x="7.07"
								...
								rx="1.65"
								ry="1.65"
								transform="translate(12.71 -4.68) rotate(45)"
								fill="#106e49"
							/>
						</g>
						<path
			...
			<div>
				...
				<p class="productTagline" style="margin-bottom: 2.5rem">
					<a class="productLink" href="https://doki-theme.unthrottled.io" target="_blank"
				...
				<div class="dokiTools">
					...
					<div class="dokiTool">
						<a href="https://github.com/doki-theme/doki-theme-jetbrains" target="_blank">
							<svg
								height="70px"
								id="Layer_1"
							...
							>
								<g>
									...
									<g>
										<rect height="43.2" style="fill: #000000" width="43.2" x="13.7" y="13.5" />
										<rect height="2.7" style="fill: #ffffff" width="16.2" x="17.7" y="48.6" />
										<polygon
		...
		<div>
			...
			<div>
				<p class="productTagline">
					...
					<span class="highlight">have more fun</span> programming with the Anime Meme IDE Integration!
				</p>
				<p class="productTagline">
					Available for all
					<a
				...
				<img alt="Anime Meme plugin preview" class="productImage" src="/anime_memes_example.gif" />
			</div>
		</div>
		<hr class="productSeparator" />
		<div>
			<div class="productIconContainer">
				...
				<div class="productExcerpt">
					...
					<h4 class="caption">Bridge the gap from imperative to declarative programming.</h4>
				</div>
			</div>
			<div>
				<p class="productTagline">
					Are you curious about
					<span class="highlight">functional</span> programming? This is a great place to start your
					<span class="highlight">declarative</span> journey!
				</p>
				<p class="productTagline">
					<a class="productLink" href="https://learn-functional.unthrottled.io" target="_blank"
		...
		<div>
			<div class="productIconContainer">
				...
				<div class="productExcerpt">
					...
					<h4 class="caption">Stay in production without breaking the bank.</h4>
				</div>
			</div>
			<div>
				<p class="productTagline">
					Everybody likes to <span class="highlight">save money</span> where they can, right? Learn
					how to go to
					<span class="highlight">production</span>
					on a budget!
				</p>
				<p class="productTagline">
					<a class="productLink" href="https://frugal-aws.unthrottled.io" target="_blank"
		...
		<div>
			<div class="productIconContainer">
				...
				<div class="productExcerpt">
					...
					<h4 class="caption">Who doesn't have one of these? Well here is mine!</h4>
				</div>
			</div>
			<div>
				<p class="productTagline">
					There are a <span class="highlight">lot of problems</span>
					that exist and cannot be solved by a simple google search alone! Take a peek at what I have
					overcome.
				</p>
				<p class="productTagline">
					<a class="productLink" href="https://blog.unthrottled.io" target="_blank"
