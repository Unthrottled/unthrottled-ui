...
<header>
  <div class="johnCena nav">
    <a on:mouseup={() => goto("/")} class="brand">Unthrottled</a>
  </div>
        ...
        <div class="navTransition">
          ...
          <div class="navLinks">
            <div class="navigationTab">
              <a on:mouseup={() => goto("/products")} class="navigationLink">
            ...
            <div class="navigationTab">
              <a on:mouseup={() => goto("/capabilities")} class="navigationLink">
            ...
            <div class="navigationTab">
              <a on:mouseup={() => goto("/values")} class="navigationLink">
            ...
            <div class="navigationTab">
              <a on:mouseup={() => goto("/contact")} class="navigationLink">
